	...
	public static void main(String[] args) {
		...
		try {
			...
			while (rs.next()) {
				...
				//rs.get- : Retrieves the value of the designated column in the current row of this ResultSet object 
				//as an int in the Java programming language.
				//retrieve : to find and bring back something
				//disignate : to choose someone officially to do a particular job:
